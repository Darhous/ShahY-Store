      ...
      <div className="wrap">
        ...
        <div className="paper">
          ...
          <Section title="٢. الأصول الرقمية والحسابات">
            ...
            {[
              ...
              ["GitHub (الكود)", "github.com/Darhous/ShahY-Store · اطلبي نقل ownership"],
        ...
        <div className="paper">
          ...
          <Section title="٤. قائمة التحقق من الاستلام">
            <CheckItem done text="الموقع يعمل على اللايف: shah-y-store.vercel.app" />
        ...
        <div className="paper">
          ...
          <Section title="٦. روابط مهمة دايماً">
            {[
              ["الموقع (الزبائن)", "shah-y-store.vercel.app"],
              ["لوحة الأدمن", "shah-y-store.vercel.app/admin/dashboard"],
              ["تسجيل دخول الأدمن", "shah-y-store.vercel.app/admin/login"],
              ["تسجيل دخول الزبائن", "shah-y-store.vercel.app/signin"],
              ["دليل إدارة المتجر", "shah-y-store.vercel.app/admin/guide/print"],
              ["Vercel Dashboard", "vercel.com/dashboard"],
              ["Supabase Dashboard", "supabase.com/dashboard"],
              ["GitHub Repository", "github.com/Darhous/ShahY-Store"],
            ].map(([label, url]) => (
